...
function TotalTempmap({data, topo}) {
    ...
    function handleDownload() {
        ...
        saveSvgAsPng(svgElement, `korea-year-tempmap-${year}.png`, {
    ...
    useEffect(() => {
        ...
        const [vmin, vmax] = values.length ? d3.extent(values) : [0, 30];
                ...
                const color = d3
                    .scaleSequential()
                    .domain([vmax, vmin]) // 높은값이 빨강, 낮은값이 파랑
