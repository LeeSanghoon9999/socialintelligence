...
function SeasonalTempmap({ data, topo }) {
    ...
    function handleDownload() {
        ...
        saveSvgAsPng(svgElement, `korea-season-tempmap-${season}.png`, {
            ...
            return {
                ...
                g.selectAll("path")
                    ...
                    .on("mouseover", function (e, d) {
                        ...
                        tooltip.html(`<strong>${d.properties.province}</strong><br/>평균기온: ${v != null ? v.toFixed(1) + " °C" : "N/A"}`)
                            .style("opacity", 1);
                    })
                    .on("mousemove", (e) => {
...
export default SeasonalTempmap;